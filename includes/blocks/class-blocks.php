...
class Blocks {
	...
	public static function init_block_editors() {
		...
		$voter_icons = [
			...
			'ballot-drop-box'           => 'Ballot Drop Box',
			...
			'electioneering-notices'    => 'Electioneering Notices',
			...
			'poll-worker-resources'     => 'Poll Worker Resources',
			...
			'security'                  => 'Security',
			'state-election-authority'  => 'State Election Authority',
